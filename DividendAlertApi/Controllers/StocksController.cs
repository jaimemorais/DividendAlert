...
namespace DividendAlertApi.Controllers
{
    ...
    public class StocksController : ControllerBase
    {
        ...
        public StocksController(IStockRepository stockRepository, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> CreateStockDocuments(string scrapeToken)
        {
            ...
            foreach (string sn in inserStockList)
            {
                ...
                {
                    await _stockRepository.InsertAsync(new Stock() { Id = Guid.NewGuid(), Name = sn });
                }
            }
